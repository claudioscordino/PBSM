 ...
 */
	...
	#define ERROR(msg) { \
		...
		onposix::Logger::getInstance().printOnFile(__FUNCTION__, __FILE__, __LINE__, \
	...
	#define ERROR(msg) { \
		...
		logger_dbg_stream__ << "[ERROR]\t"; \
		logger_dbg_stream__ << msg; \
		onposix::Logger::getInstance().printOnConsole(__FUNCTION__, __FILE__, __LINE__, \
				logger_dbg_stream__.str()); \
		}
#else
	#define ERROR(msg) { \
...
public:
	...
	void printOnFile(	const std::string&	sourceFunction,
				const std::string&	sourceFile,
				const int 		codeLine,
				const std::string& 	message);
	void printOnConsole(	const std::string&	sourceFunction,
				const std::string&	sourceFile,
				const int 		codeLine,
				const std::string& 	message);

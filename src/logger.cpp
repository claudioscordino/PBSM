 ...
 */
void Logger::printOnConsole(const std::string& function, const std::string& file,
			const int line,
			const std::string& message)
{
	...
	std::cout << "[" << std::this_thread::get_id() << ":" << (currentTime.tv_sec - initialTime_.tv_sec) << "]" <<
		     "\t[" << function << "]\t[" << file << ":" << line << "]\t" << message <<  std::endl;
 ...
 * @param message Message to be logged
 */
void Logger::printOnFile(const std::string& function, const std::string& file,
			const int line,
			const std::string& message)
{
	...
	if (logFile_ != "") {
		out_ << "[" << std::this_thread::get_id() << ":" << (currentTime.tv_sec - initialTime_.tv_sec) << "]" <<
			     "\t[" << function << "]\t[" << file << ":" << line << "]\t" << message <<  std::endl;
